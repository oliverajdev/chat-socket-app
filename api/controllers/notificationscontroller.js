...
const { createNewNotification, findNotificationsByUser, deleteUserNotification } = require("../services/notifications.services");
...
module.exports = {
    createNotification: async (req,res,next) => {
        try{
            ...
            const [notification,created] = await createNewNotification(followerId,followedId);

            if(!created) throw new ErrorObject('Notifications already exist',400);
